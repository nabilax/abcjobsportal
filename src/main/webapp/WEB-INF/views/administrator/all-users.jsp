...
<div class="container text-bg-primary">
	<table class="table table-hover my-3 text-light">
	    <thead>
	      <tr>
	        <th scope="col">#</th>
	    ...
	    <tbody>
	    	<% int i = 1; %>
		   	<c:forEach var="user" items="${users}">
		        ...
		        <td>
		          <a href="profile/${user.getUserId()}" class="text-light">Edit</a>
		          <a class="text-light" href="" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</a>
		          <a class="text-light" href="" data-bs-toggle="modal" data-bs-target="#detailModal${user.getUserId()}">Detail</a>
		        </td>
		      </tr>
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        <a href="delete/${user.getUserId()}" class="btn btn-outline-primary">Delete</a>
				      </div>
				    </div>
				  </div>
				</div>
